...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/qin-xiaogang/SendWeChatDemo"
  ...
  # Or just: spec.author    = "秦晓刚"
  # spec.authors            = { "秦晓刚" => "qinxiaogang@aliyun.com" }
  # spec.social_media_url   = "https://twitter.com/秦晓刚"
  ...
  spec.source       = { :git => "https://github.com/qin-xiaogang/SendWeChatDemo.git", :tag => "#{spec.version}" }
  ...
  #
  spec.frameworks = "AssetsLibrary", "Photos"
  ...
  # https://github.com/questbeat/QBImagePicker.git
